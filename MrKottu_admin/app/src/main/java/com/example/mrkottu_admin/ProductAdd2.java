...
public class ProductAdd2 extends AppCompatActivity {

    private static final String TAG = "ProductAdd2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ProductAdd2.this, AdminDashboard.class));
            }
        });
        //----- Page load Button -----//
        ...
        Window window = ProductAdd2.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(ProductAdd2.this, androidx.cardview.R.color.cardview_dark_background));

        mAuth = FirebaseAuth.getInstance();
        firebaseFirestore = FirebaseFirestore.getInstance();
        storageReference = FirebaseStorage.getInstance().getReference("product_images_2");
        ...
        saveProductButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!productName.isEmpty() && !productDesc.isEmpty() && !productPrice.isEmpty() && imageUri != null) {
                    ...
                    Toast.makeText(ProductAdd2.this, "Please fill in all fields and select an image", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        fileReference.putFile(imageUri)
                .addOnSuccessListener(taskSnapshot -> {
                    ...
                    fileReference.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Toast.makeText(ProductAdd2.this, "Failed to get image URL: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
                })
                .addOnFailureListener(e -> {

                    Toast.makeText(ProductAdd2.this, "Failed to upload image: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
    ...
    private void saveProductDetails(String productName, String productDesc, String productPrice, String imageURL) {
        ...
        CollectionReference productRegister = firebaseFirestore.collection("Product2");
        productRegister.add(productData)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(ProductAdd2.this, "Product added successfully", Toast.LENGTH_SHORT).show();
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(ProductAdd2.this, "Failed to add product: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
